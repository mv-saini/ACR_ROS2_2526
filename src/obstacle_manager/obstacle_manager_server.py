...
class ObstacleManager(Node):
    def __init__(self):
        ...
        self.subscriber = self.create_subscription(ObstacleManagerReport, "obstacle_manager/report_obstacle",
                                                   self.handle_obstacle_unity_request, 10)

        self.publisher = self.create_publisher(ObstacleManagerReport, "obstacle_manager/publish_obstacle", 10)
